...
class Nota
{
    ...
    {
        global $mysqli;
        $sentencia = $mysqli->prepare("SELECT id, id_aprendices, id_materia, puntaje FROM notas_aprendices_materias WHERE id_aprendices = ?");
    ...
    {
        global $mysqli;
        $sentencia = $mysqli->prepare("DELETE FROM notas_aprendices_materias WHERE id_aprendices = ? AND id_materia = ?");
